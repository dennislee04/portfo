    ...
    if request.method == "POST":
        try:
            ...
            if page_name == "workthree.html":
                ...
                formulaUsedTwo = "Correlation on the selected categories:" + f'{category_one}, {category_two}, {category_three}'
                ...
                formulaUsedThree = "Heat Map Correlation on the selected categories:" + f'{category_one}, {category_two}, {category_three}'
                ...
                fig.savefig(heatmap_file, dpi=65)
                plt.close(fig)
