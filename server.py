    ...
    if request.method == "POST":
        try:
            ...
            if (count):
                ...
                return render_template('workone.html', data1=f"**** Your password \'{pwd}\' was FOUND: {count} TIMES! You should change your password!****")
            else:
                 # return render_template('workone.html', data=f"Your password: \'{pwd[0]}\' was NOT FOUND. Carry on!")
                return render_template('workone.html', data1=f"**** Your password \'{pwd}\' was NOT FOUND! You are good to go!****")
        except:
